...
// reducers are the actions => the rules that defines how to change the box 
...
// reducer is the brain the worker the machine that follow those rules, action and do change the box.